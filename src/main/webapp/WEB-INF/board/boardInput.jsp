...
<div class="container">
	...
	<form name="myform" method="post" action="${ctp}/BoardInputOk.bo">
		<table class="table table-bordered">
			...
			<tr>
				<th>홈페이지</th>
				<td><input type="text" name="homePage" id="homePage" placeholder="홈페이지를 입력하세요" value="http://" class="form-control"></td>
			</tr>
			<tr>
				<th>글 내용</th>
			...
			<tr>
				<th>공개 여부</th>
				<td><input type="radio" name="openSw" value="OK" checked>공개 &nbsp;
				<input type="radio" name="openSw" value="NO" >비공개</td>
			</tr>
			<tr>
