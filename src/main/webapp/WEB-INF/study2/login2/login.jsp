...
<p><br/></p>
<div class="container">
  <form name="myform" method="post" action="${ctp}/LoginOk.aa">
    <table class="table table-bordered text-center">
      <tr>
        <td colspan="2"><font size="5">로 그 인3</font></td>
      </tr>
      <tr>
        <th>아이디</th>
      ...
      <tr>
        <td colspan="2">
          ...
          <input type="button" value="회원가입" onclick="location.href='${ctp}/Join.aa';" class="btn btn-primary mr-4"/>
