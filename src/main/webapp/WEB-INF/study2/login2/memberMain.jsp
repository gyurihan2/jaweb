...
<head>
  ...
  <script>
    ...
    function idCheck() {
    	...
    	location.href = "${ctp}/database/LoginSearch.aa?mid="+mid;
    }
...
<div class="container text-center">
  ...
  <div class="row">
    ...
    <div class="col"><a href="${ctp}/database/List.aa" class="btn btn-success">전체조회</a></div>
    <div class="col"><a href="${ctp}/Logout.aa" class="btn btn-danger">로그아웃</a></div>
    <div class="col"></div>
  </div>
  <hr/>
  <div id="demo"></div>
