...
<div class="container">
  <h2>회원 정보 수정</h2>
  <form name="myform" method="post" action="${ctp}/database/UpdateOk.aa">
  	<table class="table text-center">
  	  ...
  	  <tr>
  	    <td colspan="2" class="text-center">
  	      ...
  	      <input type="button" value="돌아가기" onclick="location.href='${ctp}/study/0428_database/MemberMain.aa';" class="btn btn-warning"/>
  	    </td>
  	  </tr>
  	</table>
  </form>
