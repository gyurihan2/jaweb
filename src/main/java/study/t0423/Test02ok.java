...
@WebServlet("/0423/test02ok")
public class Test02ok extends HttpServlet{
	@Override
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Test02VO vo = new Test02VO(name, hakbun, kor, eng, mat, soc, sci, tot, avg, grade);
		
		request.setAttribute("vo", vo);
		
		String viewPage="/study/0423/test02Res.jsp";
