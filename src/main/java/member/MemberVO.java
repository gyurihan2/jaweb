...
public class MemberVO {
	...
	public String toString() {
		return "MemberVO [idx=" + idx + ", point=" + point + ", level=" + level + ", visitCnt=" + visitCnt
				+ ", todayCnt=" + todayCnt + ", mid=" + mid + ", pwd=" + pwd + ", nickName=" + nickName + ", name="
				+ name + ", gender=" + gender + ", birthday=" + birthday + ", tel=" + tel + ", address=" + address
				+ ", email=" + email + ", homePage=" + homePage + ", job=" + job + ", hobby=" + hobby + ", photo="
